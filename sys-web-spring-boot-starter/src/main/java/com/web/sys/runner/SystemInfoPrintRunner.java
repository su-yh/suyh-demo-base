...
@Slf4j
public class SystemInfoPrintRunner implements ApplicationRunner {
    ...
    private void printSystemInfo(StringBuilder sb) {
        ...
        if (osMXBean instanceof com.sun.management.OperatingSystemMXBean) {
            ...
            long totalPhysicalMemory = osBean.getTotalPhysicalMemorySize() / (1024 * 1024); // 系统总物理内存
            long freePhysicalMemory = osBean.getFreePhysicalMemorySize() / (1024 * 1024);   // 系统空闲物理内存
