...
public class ExportDetailDto {
    ...
    @Excel(sort = 3, name = "detailDto02", minParseUnit = false, useParentHeaderStyle = false, headerBackgroundColor = IndexedColors.LIGHT_YELLOW, headerColor = IndexedColors.BLACK)
